...
def main() -> None:
    ...
    cdc_password = required("CDC_DB_PASSWORD")
    try:
    ...
    try:
        ...
        role_identifiers = {
            ...
            cdc_user: quote_identifier(cdc_user, "CDC_DB_USER"),
        }
        ...
        replacements = {
            ...
            "productivity_cdc": role_identifiers[cdc_user],
        }
        migrations = []
        ...
        cursor.execute(
            f"ALTER ROLE {role_identifiers[cdc_user]} LOGIN PASSWORD "
            f"{quote_literal(cdc_password)}"
        )
